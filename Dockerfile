...
RUN su - postgres -s /bin/sh -c "/usr/lib/postgresql/15/bin/initdb -D /usr/lib/postgresql/15/data;\
/usr/lib/postgresql/15/bin/pg_ctl start -D /usr/lib/postgresql/15/data"\
...
CMD nginx && su - portgres -s /bin/sh -c "/usr/lib/postgresql/15/bin/pg_ctl start -D /usr/lib/postgresql/15/data"\
